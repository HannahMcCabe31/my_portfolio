  ...
  return (
    <header className="bg-rose-800 sticky top-0 z-10 ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <h1 className="title-font font-sans font-medium text-white mb-4 md:mb-0 hover:text-rose-400">
          <a href="#about" className=" text-xl" >
            Hannah McCabe
          </a>
        </h1>
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-rose-300 flex flex-wrap items-center text-base justify-center">
